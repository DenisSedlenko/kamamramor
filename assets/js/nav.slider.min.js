...
var BtnGroup = function () {
  function BtnGroup(group) {
    ...
    this.group = group;
    this.buttons = Array.prototype.slice.call(this.group.querySelectorAll('.quote-btn-dot'));
    this.slides = Array.prototype.slice.call(document.querySelectorAll('.quote-row'));
    this.slideContainer = document.querySelector('.quote-wrapper');
    this.widthChild = $('.quote-row').width();
    this.slideContainer.style.width = this.slides.length*this.widthChild+'px';
  ...
  _createClass(BtnGroup, [{
    ...
    value: function activateIndex(index) {
      $(this.slideContainer).css("transform","translateX("+index*-this.widthChild+"px)");
